...
function clientCode() {
    let hostingFactory: HostingPlanAbstractFactory = HostingPlanFactoryMethod.getType(OSType.WINDOWS);

    let economyHostingPlan: EconomyHostingPlan = hostingFactory.createEconomyHosting();
    console.log(economyHostingPlan.getFeatures());

    let deluxeHostingPlan: DeluxeHostingPlan = hostingFactory.createDeluxeHosting();
    console.log(deluxeHostingPlan.getFeatures());

    let ultimateHostingPlan: UltimateHostingPlan = hostingFactory.createUltimateHosting();
